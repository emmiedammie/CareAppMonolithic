  ...
  return (
    <div>
      <h2 id="rota-heading" data-cy="RotaHeading">
        <Translate contentKey="careAppMonoApp.rota.home.title">Rotas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="careAppMonoApp.rota.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/rota/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="careAppMonoApp.rota.home.createLabel">Create new Rota</Translate>
          </Link>
        </div>
      </h2>
        ...
        {rotaList && rotaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="careAppMonoApp.rota.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="careAppMonoApp.rota.client">Client</Translate>
                </th>
                <th>
                  <Translate contentKey="careAppMonoApp.rota.carer">Carer</Translate>
                </th>
                <th>
                  <Translate contentKey="careAppMonoApp.rota.time">Time</Translate>
                </th>
                <th>
                  <Translate contentKey="careAppMonoApp.rota.duration">Duration</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="careAppMonoApp.rota.home.notFound">No Rotas found</Translate>
            </div>
          )
        )}
      </div>
