  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="careAppMonoApp.rota.home.createOrEditLabel" data-cy="RotaCreateUpdateHeading">
            <Translate contentKey="careAppMonoApp.rota.home.createOrEditLabel">Create or edit a Rota</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('careAppMonoApp.rota.client')}
                id="rota-client"
                name="client"
                data-cy="client"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.rota.carer')}
                id="rota-carer"
                name="carer"
                data-cy="carer"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.rota.time')}
                id="rota-time"
                name="time"
                data-cy="time"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.rota.duration')}
                id="rota-duration"
                name="duration"
                data-cy="duration"
                type="text"
