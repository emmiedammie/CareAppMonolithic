  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="careAppMonoApp.visit.home.createOrEditLabel" data-cy="VisitCreateUpdateHeading">
            <Translate contentKey="careAppMonoApp.visit.home.createOrEditLabel">Create or edit a Visit</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('careAppMonoApp.visit.client')}
                id="visit-client"
                name="client"
                data-cy="client"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.visit.address')}
                id="visit-address"
                name="address"
                data-cy="address"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.visit.carer')}
                id="visit-carer"
                name="carer"
                data-cy="carer"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.visit.accesscode')}
                id="visit-accesscode"
                name="accesscode"
                data-cy="accesscode"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.visit.timein')}
                id="visit-timein"
                name="timein"
                data-cy="timein"
                type="datetime-local"
              ...
              />
              <ValidatedField
                label={translate('careAppMonoApp.visit.status')}
                id="visit-status"
                name="status"
                data-cy="status"
                type="select"
              >
                {statusValues.map(status => (
                  <option value={status} key={status}>
                    {translate('careAppMonoApp.Status.' + status)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('careAppMonoApp.visit.timespent')}
                id="visit-timespent"
                name="timespent"
                data-cy="timespent"
                type="text"
              ...
              />
              <ValidatedField id="visit-rota" name="rota" data-cy="rota" label={translate('careAppMonoApp.visit.rota')} type="select">
                <option value="" key="0" />
                {rotas
              ...
              <ValidatedField id="visit-carer" name="carer" data-cy="carer" label={translate('careAppMonoApp.visit.carer')} type="select">
                <option value="" key="0" />
                {carers
