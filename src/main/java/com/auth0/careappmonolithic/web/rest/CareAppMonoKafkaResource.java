...
@RestController
@RequestMapping("/api/care-app-mono-kafka")
public class CareAppMonoKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CareAppMonoKafkaResource.class);
    ...
    public CareAppMonoKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
